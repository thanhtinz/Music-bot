...
export const COMMAND_CATALOG: readonly CommandMeta[] = [
  ...
  {
    name: 'forward',
    description: 'Jump ahead, 10 seconds by default',
    category: 'playback',
    aliases: ['ff', 'fwd'],
    options: [{ name: 'seconds', description: 'How far, e.g. 30 or 1:00' }],
    tier: 'dj',
    requiresVoice: true,
  },
  {
    name: 'rewind',
    description: 'Jump back, 10 seconds by default',
    category: 'playback',
    aliases: ['rw'],
    options: [{ name: 'seconds', description: 'How far, e.g. 30 or 1:00' }],
    tier: 'dj',
  ...
  {
    name: 'replay',
    description: 'Start the current track again',
    category: 'playback',
    aliases: ['restart'],
    tier: 'dj',
    requiresVoice: true,
